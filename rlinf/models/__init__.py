...
def _register_builtin_models():
    ...
    def _build_psi_policy(cfg: DictConfig, torch_dtype):
        from rlinf.models.embodiment.psi_policy import get_model
    ...
    register_model(
        SupportedModel.PSI_POLICY.value,
        _build_psi_policy,
        category="embodied",
        force=True,
    )
...
def get_model(cfg: DictConfig):
    model_type = SupportedModel(str(cfg.model_type))
    model_builder = _MODEL_REGISTRY.get(model_type.value)
