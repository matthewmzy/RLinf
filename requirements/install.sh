...
SUPPORTED_ENVS=("behavior" "maniskill_libero" "metaworld" "calvin" "isaaclab" "robocasa" "franka" "frankasim" "robotwin" "habitat" "opensora" "wan" "xsquare_turtle2" "liberopro" "liberoplus" "a2d" "roboverse" "embodichain" "d4rl" "dosw1")
...
install_env_only() {
    ...
    case "$ENV_NAME" in
        a2d)
            install_common_embodied_deps
            uv sync --extra a2d --active $NO_INSTALL_RLINF_CMD
        d4rl)
            install_d4rl_env
            ;;
        franka)
